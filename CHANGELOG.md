...
### Fixed
- Packaging: include `web` templates and static assets as package data so Flask templates (`index.html`) and static files are available after installation (fixes TemplateNotFound)
